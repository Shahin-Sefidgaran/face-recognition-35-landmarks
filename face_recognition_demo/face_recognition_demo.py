...
def build_argparser():
    ...
    gallery.add_argument('-fg', metavar="PATH", default="./face_gallery",
    ...
    models.add_argument('-m_lm', metavar="PATH", default="./facial-landmarks-35-adas-0002.xml",
...
class Visualizer:
    ...
    @staticmethod
    def open_input_stream(path='rtps://admin:poiu1234@192.168.77.231:554/user=admin_password=poiu1234_channel=0_stream0.stp'):
